      ...
      <div className="relative mt-[8px]">
        ...
        {isOpen && (
          <div className="absolute mt-2 p-2 bg-white border-[1px] border-[#C3C3C3] rounded-[10px] w-full flex flex-col px-[20px] z-10">
            <ButtonDropdown
              title="9.00 AM - 11.59 AM"
              className={`${
                selectedOption === "9.00 AM - 11.59 AM" ? "font-bold" : ""
              }`}
              onClick={() => handleOptionClick("9.00 AM - 11.59 AM")}
            />
            <ButtonDropdown
              title="zzzzzz"
              className={`${selectedOption === "zzzzzz" ? "font-bold" : ""}`}
              onClick={() => handleOptionClick("zzzzzz")}
            />
            <ButtonDropdown
              title="zzzzzz"
              className={`${selectedOption === "zzzzzz" ? "font-bold" : ""}`}
