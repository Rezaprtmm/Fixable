			...
			<div className="relative mt-[8px]">
				...
				{isOpen && (
					<div className="absolute mt-2 p-2 bg-white border-[1px] border-[#C3C3C3] rounded-[10px] w-full flex flex-col px-[20px] z-10">
						<ButtonDropdown title="Online" className={`${selectedOption === "Online" ? "font-bold" : ""}`} onClick={() => handleOptionClick("Online")} />
						<ButtonDropdown title="Offline" className={`${selectedOption === "Offline" ? "font-bold" : ""}`} onClick={() => handleOptionClick("Offline")} />
					</div>
				)}
