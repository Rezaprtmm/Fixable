...
export default function CardPayment({ formCred }: any) {
	...
	return (
		<div className="grid grid-cols-2 mt-[24px] h-[700px] border-[1px] border-[#D5D5D5] rounded-[20px]">
			{isSuccess ? (
				<div></div>
			) : (
			...
			<div className="bg-va bg-cover bg-no-repeat rounded-r-[20px] w-full justify-center flex flex-col items-center">
				{isSuccess ? (
					<div className="bg-white w-[70%] shadow-payment flex flex-col px-[20px] rounded-[10px] py-[60px]">
						<h3 className="text-info-main font-poppins text-[16px] font-bold leading-[130%] text-center">Yuhuu, Payment Successfully!</h3>
						<div className="flex flex-col gap-[8px] items-center mt-[74px]">
							<SuccessPayment />
						</div>
						<div className="flex flex-row items-center justify-center">
							<Link href={"/history/payment-history"} className="border-b-[1px] border-b-info-main py-[13px] text-info-main font-poppins text-[12px] font-normal leading-[170%] mt-[71px]">
								See payment history
							</Link>
						</div>
					</div>
