			...
			<div className="flex flex-col p-[20px]">
				...
				{paymentMethod ? (
					<div className="flex flex-col mt-[24px] gap-[16px] pb-[57px]">
						...
						<LabelRes title="Company code" value={companyCode} onChange={handleCompanyCode} type="text" className="hidden" />
						<LabelRes title="Virtual account number" value={vaNumber} onChange={handleVaNumber} type="text" className="hidden" />
						<LabelCoupon title="Coupon" onChange={handleCoupon} />
					</div>
				) : (
					<div className="flex flex-col mt-[24px] gap-[16px] pb-[57px]">
						<LabelEWallet title="Choose e-wallet" onChange={handleEWallet} />
						<LabelRes title="e-wallet number" value={eWalletNumber} onChange={handleEWalletNumber} type="text" className="hidden" placeholder="Type your e-wallet number" />
						<LabelCoupon title="Coupon" onChange={handleCoupon} />
					</div>
				)}
			</div>
