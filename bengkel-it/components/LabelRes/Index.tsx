...
export default function LabelRes(props: LabelResProps) {
	const { title, type, className, isChecked, onCheckboxChange, onChange, value } = props;
	...
	return (
		<div className="flex flex-col">
			...
			<input type={type} className="border-[1px] border-[#f8f8f8] h-[60px] rounded-[10px] shadow-input px-[20px] text-dark-2 font-poppinstext-[16px] font-normal leading-[170%] mt-[8px]" onChange={handler} value={value} />
		</div>
	);
}
