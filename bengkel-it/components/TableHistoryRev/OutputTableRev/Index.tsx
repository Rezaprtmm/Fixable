  ...
  return (
    <div className="grid grid-cols-7 border-[1px] border-[#D5D5D5] rounded-[10px] items-center">
      <div className="pl-[20px] pr-[20px] py-[20px]">
        <p className="text-black font-poppins text-[12px] font-normal leading-[170%]">{uniqCode}</p>
      </div>
      <div className="pl-[20px] pr-[20px] py-[20px]">
        <p className="text-black font-poppins text-[12px] font-normal leading-[170%]">{id}</p>
      </div>
      <div className="pl-[20px] pr-[20px] py-[20px]">
        <p className="text-black font-poppins text-[12px] font-normal leading-[170%]">{overalRate}</p>
      </div>
      <div className="pl-[20px] col-span-2 pr-[20px] py-[20px] flex flex-row gap-[16px]">
        <p className="text-black font-poppins text-[12px] font-normal leading-[170%] flex flex-row items-center gap-[16px]">{comment}</p>
      </div>
      <div className="pl-[20px] pr-[20px] py-[20px]">
        <p className="text-black font-poppins text-[12px] font-normal leading-[170%]">{revDate}</p>
      </div>
      <div className="pl-[20px] pr-[20px] py-[20px]">
        {isReview ? (
