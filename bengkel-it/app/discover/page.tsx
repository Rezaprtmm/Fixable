      ...
      <div className="ml-[296px] mt-[40px] pr-[40px] pb-[180px]">
        ...
        {isActiveForm ? (
          <div className="grid grid-cols-1 mt-[24px] p-[20px] border-[1px] border-warning-darker rounded-[10px]">
            ...
            <p className="text-dark-3 font-poppins text-[12px] font-normal leading-[170%] italic">61% completed</p>
            <div className="grid grid-cols-6 mt-[24px] items-start gap-[5px]">
              <StatusBar title="Reservation" desc1="Reservation accepted" className2="hidden" className3="hidden" />
              <StatusBar title="Appointment" desc1="Appointment approved" className2="hidden" className3="hidden" />
              <StatusBar title="Meeting" desc1="Meeting completed" className2="hidden" className3="hidden" />
              <StatusBar title="Working Process" desc1="In queue" desc2="In progress" desc3="Complete" className3="text-dark-4" />
              <StatusBar title="Payment" desc1="Payment paid" className2="hidden" className3="hidden" />
              <StatusBar title="End stage" desc1="Device ready" desc2="Device taken" className1="text-dark-4" className2="text-dark-4" className3="hidden" />
            </div>
          </div>
        ) : (
          <div></div>
