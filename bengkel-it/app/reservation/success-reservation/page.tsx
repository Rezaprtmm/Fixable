          ...
          <div className="col-span-2 border-[1px] border-[#D5D5D5] rounded-[20px] p-[20px] h-[800px] flex flex-col">
            ...
            <div className="flex flex-col items-center mt-[60px] gap-[40px]">
              ...
              <p className="text-dark-2 font-poppins text-[16px] font-normal leading-[130%] text-center">
                Your reservation has been successfully submitted, you will
                receive an email containing the ticket within a few moments. The
                meeting you are expecting will be announced via WhatsApp.
              </p>
            </div>
            <div className="flex flex-row items-center  justify-center mt-[40px]">
              <Link
                href={"/history/service-history"}
                className="bg-info-main px-[16px] py-[8px] rounded-[6px] text-white font-poppins text-[12px] font-normal leading-[170%]"
              >
                Track Process
              </Link>
            </div>
