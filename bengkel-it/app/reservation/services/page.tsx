					...
					<div className="col-span-2 border-[1px] border-[#D5D5D5] rounded-[20px] p-[20px] h-[800px] flex flex-col justify-between">
						<div className="flex flex-col">
							...
							<div className="flex flex-col mt-[24px] gap-[16px]">
								{/* Service category */}
								<LabelButtonServ title="Service category" />

								{/* Problem category */}
								<LabelProblemServ title="Problem" />
								...
								<div className="flex flex-col">
									...
									<textarea name="" id="" className="border-[1px] border-[#f8f8f8] h-[180px] rounded-[10px] shadow-input px-[20px] py-[17px] text-dark-2 font-poppinstext-[16px] font-normal leading-[170%] mt-[8px]"></textarea>
								</div>
