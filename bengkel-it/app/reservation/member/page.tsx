...
export default function Member() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    fetch("http://localhost:3001/reserve", {
      ...
      mode: "cors",
      body: JSON.stringify({ fullname, email, major, phoneNumber, nim }),
    })
          ...
          <div className="col-span-2 border-[1px] border-[#D5D5D5] rounded-[20px] p-[20px] h-[800px] flex flex-col justify-between">
            <div className="flex flex-col">
              ...
              <div className="flex flex-col mt-[24px] gap-[16px]">
                {/* Fulname */}
                <LabelRes title="Fullname" type="text" isChecked={nameChecked} onCheckboxChange={handleNameCheckboxChange} onChange={handleFullname} value={fullname} />

                {/* EMail */}
                <LabelRes title="Active email" type="text" isChecked={emailChecked} onCheckboxChange={handleEmailCheckboxChange} onChange={handleEmail} value={email} />
