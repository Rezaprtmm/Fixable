...
export default function Member() {
	...
	const isRequiredFieldsFilled = fullname && email && major !== "Choose a category" && phoneNumber;
				...
				<div className="mt-[24px] grid grid-cols-3 gap-[40px]">
					...
					<div className="col-span-2 border-[1px] border-[#D5D5D5] rounded-[20px] p-[20px] h-[800px] flex flex-col justify-between">
						...
						<div className="flex flex-col items-end">
							<button
								className={`${isRequiredFieldsFilled ? "bg-info-main" : "bg-dark-4"} px-[24px] py-[12px] flex flex-row items-center text-white font-poppins text-[16px] font-normal leading-[170%] rounded-[10px] gap-[8px]`}
