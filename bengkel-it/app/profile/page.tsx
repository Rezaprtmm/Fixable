				...
				<div className="mt-[24px] grid grid-cols-3 gap-[40px]">
					...
					<div className="col-span-2 flex flex-col">
						...
						<div className="flex flex-col mt-[16px] gap-[16px]">
							...
							<InputLabelProfile label="Email" icon={<Copy className="text-info-main" />} />
							<InputLabelProfile label="Phone" icon={<IconEditPhone />} />
						</div>
						<button className="bg-info-main rounded-[10px] py-[16px] mt-[16px] text-white font-poppins text-[16px] font-normal leading-[170%]">Edit Information</button>
					</div>
				</div>
			</div>
		</div>
