...
export default function SignUp() {
	...
	return (
		<div className="pl-[100px] flex flex-col mt-[28px]">
			<Image src={"/images/Logo.svg"} alt="Logo" width={0} height={0} sizes="100%" className="w-full max-w-[200px] h-12  mt-[28px]" />
			<div className="flex flex-row items-center mt-[64px]">
				<div className="w-[40%]">
					...
					<div className="flex flex-col mt-[24px] w-[51vh]">
						...
						<button className="w-full bg-gradient-to-r from-black to-blue-main py-[17px] rounded-[10px] text-[#ffff] text-[16px] font-poppins font-normal leading-[170%] mt-[16px]" onClick={handleSubmit}>
							Sign up
						</button>
					</div>
