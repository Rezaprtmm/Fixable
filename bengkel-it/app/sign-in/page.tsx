		...
		<div className="pl-[100px] mx-auto flex flex-row h-screen">
			<div className="flex flex-col w-[40%] pr-[125px]">
				...
				<div className="flex flex-col mt-[25px] w-[51vh]">
					<Label name="Username or email" type="email" icon={<IconUsername />} />
					<Label name="Password" forgot="Forgot Password?" type="password" icon={<IconPassword />} className="mt-[16px]" />
					<button className="w-full bg-blue-main py-[17px] rounded-[10px] text-[#ffff] text-[16px] font-poppins font-normal leading-[170%] mt-[24px]">Sign in</button>
				</div>
