...
export default function SignIn() {
  ...
  useEffect(() => {
    const isLogin = async function () {
      const loginCheck = await axios.post("http://localhost:3001/session", {
        request,
      });
    ...
    <div className="pl-[100px] mx-auto flex flex-row h-screen">
      <div className="flex flex-col w-[40%] pr-[125px]">
        ...
        <div className="flex flex-col mt-[25px] w-[51vh]">
          ...
          />
          <button
            className="w-full bg-gradient-to-r from-black to-blue-main py-[17px] rounded-[10px] text-[#ffff] text-[16px] font-poppins font-normal leading-[170%] mt-[24px]"
