							...
							<div className="w-full flex flex-col mt-[24px]">
								...
								<div className="flex flex-col mt-[16px]">
									...
									<textarea
										...
										id=""
										className="border-[1px] border-[#f8f8f8] h-[180px] rounded-[10px] shadow-input px-[20px] py-[17px] text-dark-2 font-poppinstext-[16px] font-normal leading-[170%] mt-[8px]"></textarea>
								</div>
							</div>
						</div>
